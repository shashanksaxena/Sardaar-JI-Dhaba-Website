...
export const menu: MenuItem[] = [
  ...
  { id: 'chicken-changezi', name: 'Chicken Changezi', description: 'A rich and mildly tangy chicken curry with a classic Changezi-style masala.', category: 'Main Course', price: '₹260 / 420 / 660', image: '/images/menu/menu-non-vegetarian.jpg' },
  ...
  { id: 'tandoori-roti', name: 'Tandoori Roti', description: 'Classic whole wheat flatbread cooked in the tandoor.', category: 'Breads', price: '₹20 / 25', image: '/images/blog/restaurant-style-garlic-naan.png' },
  { id: 'tawa-roti', name: 'Tawa Roti', description: 'Soft roti prepared on a hot tawa for quick service.', category: 'Breads', price: '₹20 / 25', image: '/images/blog/restaurant-style-garlic-naan.png' },
  { id: 'rumali-roti', name: 'Rumali Roti', description: 'Thin, soft folded roti with a light hand-feel.', category: 'Breads', price: '₹20 / 25', image: '/images/blog/restaurant-style-garlic-naan.png' },
  ...
  { id: 'cheese-naan', name: 'Cheese Naan', description: 'Soft naan topped with cheese and a savoury finish.', category: 'Breads', price: '₹110 / 115', image: '/images/blog/restaurant-style-garlic-naan.png' },
  { id: 'paneer-naan', name: 'Paneer Naan', description: 'Naan stuffed with paneer and cooked till soft and blushed.', category: 'Breads', price: '₹110 / 115', image: '/images/blog/restaurant-style-garlic-naan.png' },
  { id: 'lachha-paratha', name: 'Lachha Paratha', description: 'Layered whole wheat paratha with a crisp finish.', category: 'Breads', price: '₹55', image: '/images/blog/restaurant-style-garlic-naan.png' },
  ...
  { id: 'matar-pulao', name: 'Matar Pulao', description: 'Basmati rice with peas and gentle spice.', category: 'Rice & Biryani', price: '₹160', image: '/images/restaurant/signature-thali.jpg' },
  { id: 'veg-biryani', name: 'Veg Biryani', description: 'Aromatic basmati rice layered with vegetables and warm spices.', category: 'Rice & Biryani', price: '₹180', image: '/images/restaurant/signature-thali.jpg' },
  ...
  { id: 'dal-tadka', name: 'Dal Tadka', description: 'Classic yellow lentils tempered with ghee, cumin and spices.', category: 'Rice & Biryani', price: '₹160', image: '/images/blog/restaurant-style-dal-makhani.png' },
  { id: 'dhaba-dal-fry', name: 'Dhaba Dal Fry', description: 'Dhaba-style dal with bold tempering and a rich, rustic finish.', category: 'Rice & Biryani', price: '₹180', image: '/images/blog/restaurant-style-dal-makhani.png' },
  { id: 'dal-makhani', name: 'Dal Makhani', description: 'Slow-cooked black lentils finished with butter, cream and dhaba-style patience.', category: 'Rice & Biryani', price: '₹220', image: '/images/blog/restaurant-style-dal-makhani.png' },
  { id: 'pindi-chole', name: 'Pindi Chole', description: 'Classic Punjabi chole with a deep masala and hearty texture.', category: 'Rice & Biryani', price: '₹240', image: '/images/restaurant/signature-thali.jpg' },
  ...
  { id: 'plain-raita', name: 'Plain Raita', description: 'Cool yoghurt with cucumber and fine herbs.', category: 'Raita & Salad', price: '₹80', image: '/images/people/guest-table.jpg' },
  { id: 'boondi-raita', name: 'Boondi Raita', description: 'Refreshing yoghurt with boondi and seasoning.', category: 'Raita & Salad', price: '₹110', image: '/images/people/guest-table.jpg' },
  ...
  { id: 'mix-salad', name: 'Mix Salad', description: 'A crisp mixed vegetable salad for balance alongside richer dishes.', category: 'Raita & Salad', price: '₹90', image: '/images/people/guest-table.jpg' },
  { id: 'plain-papad', name: 'Plain Papad', description: 'Roasted papad served as a light side.', category: 'Raita & Salad', price: '₹20', image: '/images/people/guest-table.jpg' },
  { id: 'masala-papad', name: 'Masala Papad', description: 'Crisp papad topped with masala and fresh seasoning.', category: 'Raita & Salad', price: '₹30', image: '/images/people/guest-table.jpg' },
  { id: 'cream-of-tomato-soup', name: 'Cream of Tomato Soup', description: 'Simple tomato soup with a smooth, comforting body.', category: 'Soups', price: '₹140', image: '/images/menu/menu-vegetarian.jpg' },
  ...
  { id: 'dhaba-style-noodles', name: 'Dhaba Style Noodles', description: 'A robust desi-style noodle dish with wok-tossed vegetables and spices.', category: 'Desi Style Chinese', price: '₹220', image: '/images/menu/menu-vegetarian.jpg' },
  { id: 'paneer-noodles', name: 'Paneer Noodles', description: 'Noodles tossed with paneer and a gentle Indo-Chinese flavour profile.', category: 'Desi Style Chinese', price: '₹240', image: '/images/menu/menu-vegetarian.jpg' },
  { id: 'chilli-garlic-noodles', name: 'Chilli Garlic Noodles', description: 'Garlicky noodles with a lively chilli kick and crisp vegetables.', category: 'Desi Style Chinese', price: '₹280', image: '/images/menu/menu-vegetarian.jpg' },
  { id: 'dhaba-style-fried-rice', name: 'Dhaba Style Fried Rice', description: 'Fragrant fried rice with desi-style seasoning and crisp vegetables.', category: 'Desi Style Chinese', price: '₹220', image: '/images/restaurant/signature-thali.jpg' },
  { id: 'chilli-garlic-fried-rice', name: 'Chilli Garlic Fried Rice', description: 'Fried rice with garlic, chilli and a robust Indo-Chinese finish.', category: 'Desi Style Chinese', price: '₹240', image: '/images/restaurant/signature-thali.jpg' },
  { id: 'schezwan-noodles', name: 'Schezwan Noodles', description: 'Noodles tossed with Schezwan sauce, vegetables and a spicy finish.', category: 'Desi Style Chinese', price: '₹240', image: '/images/menu/menu-vegetarian.jpg' },
  { id: 'schezwan-rice', name: 'Schezwan Rice', description: 'Fried rice with Schezwan-style heat and vibrant seasoning.', category: 'Desi Style Chinese', price: '₹240', image: '/images/restaurant/signature-thali.jpg' },
  { id: 'chilli-paneer-dry', name: 'Chilli Paneer (Dry)', description: 'Crispy paneer tossed with onion, capsicum and chilli sauce.', category: 'Desi Style Chinese', price: '₹240', image: '/images/blog/restaurant-style-paneer-tikka.png' },
  { id: 'veg-manchurian-dry', name: 'Veg Manchurian (Dry)', description: 'Crisp vegetable balls tossed in a sweet-spicy Indo-Chinese glaze.', category: 'Desi Style Chinese', price: '₹240', image: '/images/menu/menu-vegetarian.jpg' },
  { id: 'paneer-65', name: 'Paneer 65', description: 'Paneer bites coated in a spiced batter and finished dry.', category: 'Desi Style Chinese', price: '₹250', image: '/images/blog/restaurant-style-paneer-tikka.png' },
  { id: 'chilli-mushroom-dry', name: 'Chilli Mushroom (Dry)', description: 'Mushrooms tossed with chilli, garlic and a sharper Indo-Chinese masala.', category: 'Desi Style Chinese', price: '₹240', image: '/images/menu/menu-vegetarian.jpg' },
  { id: 'chilli-paneer-gravy', name: 'Chilli Paneer (Gravy)', description: 'Paneer in a rich, savoury gravy with onion, capsicum and chilli notes.', category: 'Desi Style Chinese', price: '₹250', image: '/images/blog/restaurant-style-shahi-paneer.png' },
  { id: 'veg-manchurian-gravy', name: 'Veg Manchurian (Gravy)', description: 'Vegetable balls in a glossy Indo-Chinese gravy with a sweet-spicy finish.', category: 'Desi Style Chinese', price: '₹250', image: '/images/menu/menu-vegetarian.jpg' },
  { id: 'chilli-chicken-dry', name: 'Chilli Chicken (Dry)', description: 'Crisp chicken tossed in a spicy chilli-garlic sauce.', category: 'Desi Style Chinese', price: '₹320', image: '/images/menu/menu-non-vegetarian.jpg' },
  { id: 'chilli-chicken-gravy', name: 'Chilli Chicken (Gravy)', description: 'Chicken in a rich gravy with chilli, garlic and thick sauce.', category: 'Desi Style Chinese', price: '₹340', image: '/images/menu/menu-non-vegetarian.jpg' },
  { id: 'chicken-65', name: 'Chicken 65', description: 'Spicy chicken bites with a crisp finish and classic Indo-Chinese flavour.', category: 'Desi Style Chinese', price: '₹320', image: '/images/menu/menu-non-vegetarian.jpg' },
  { id: 'chicken-lollypop', name: 'Chicken Lollypop', description: 'Crispy chicken wings with a savoury, spiced coating.', category: 'Desi Style Chinese', price: '₹340', image: '/images/menu/menu-non-vegetarian.jpg' },
...
const additionalStories: BlogPost[] = [
  {
    id: 'top-5-restaurants-to-eat-in-prayagraj',
    publishedAt: '2026-09-14',
    category: 'City guide',
    title: 'Top 5 Restaurants to Eat in Prayagraj',
    excerpt: 'From family-style Punjabi comfort to a relaxed evening meal, these are the top restaurants to eat in Prayagraj — with Sardaar JI Dhaba at the very top.',
    read: '4 min read',
    ...
    body: [
      'Prayagraj is a city where a satisfying meal is never far away. Whether you are in the mood for a proper Punjabi feast, a quick tandoori bite or a relaxed family dinner, the city offers plenty of places that feel worth returning to. If you are searching for the best restaurants in Prayagraj, this shortlist is a great place to begin.',
      '1. Sardaar JI Dhaba — Sardaar JI Dhaba deserves the top spot for its rich Punjabi menu, warm dining atmosphere and generous portions. It is the kind of place where you can settle in for butter chicken, dal makhani, tandoori starters and breads, knowing the food will feel comforting and familiar from the first bite to the last.',
      '2. A classic Punjabi family restaurant in Civil Lines — This kind of restaurant works beautifully for group dinners, especially when you want a broader menu that covers curries, breads, rice and vegetarian favourites without fuss.',
      '3. A popular kebab and biryani stop in the city centre — For lovers of grilled food, biryani and spice, these neighbourhood spots offer hearty meals that feel lively and satisfying after a long day out.',
      '4. A relaxed cafe-style dining place near the main market — Perfect for casual evenings, these spots are ideal when you want good food, comfortable seating and a less formal setting for conversation over chai or dinner.',
      '5. A local favourite for desserts and late-night comfort food — Some of the best meals in Prayagraj are the ones you discover by accident, especially when a restaurant becomes your go-to corner for evening snacks, sweets and a simple, satisfying plate.',
      'The best restaurant for you depends on what kind of food you want, but if you are looking for one reliably memorable place, Sardaar JI Dhaba is the right first stop. It blends the warmth of a dhaba, the comfort of Punjabi classics and the kind of hospitality that makes people want to come back again.',
    ],
  },
  {
    id: 'top-5-places-to-visit-in-prayagraj',
    publishedAt: '2026-09-13',
    category: 'City guide',
    title: 'Top 5 Places to Visit in Prayagraj',
    excerpt: 'Plan your Prayagraj trip around the city’s most iconic experiences, from Sangam to heritage landmarks and peaceful gardens.',
    read: '4 min read',
    image: '/images/restaurant/dhaba-exterior.jpg',
    alt: 'Prayagraj city view with heritage and riverfront landmarks',
    keywords: 'places to visit in Prayagraj, top attractions in Prayagraj, what to see in Prayagraj, Prayagraj travel guide',
    seoTitle: 'Top 5 Places to Visit in Prayagraj | City Guide',
    seoDescription: 'Discover the top places to visit in Prayagraj, including Sangam, Anand Bhawan, Khusro Bagh and other iconic landmarks.',
    body: [
      'Prayagraj is more than a city of pilgrimage and history; it is a place where heritage, riverfront views and everyday life come together in a very lively way. If you are visiting for the first time, these five places give you a strong introduction to what makes the city special.',
      'Triveni Sangam is the most important stop for most visitors. It is where the Ganga, Yamuna and the invisible Saraswati meet, and the riverfront area offers a calm, spiritual atmosphere that is hard to forget. Early mornings are especially beautiful here.',
      'Anand Bhawan is one of the city’s most celebrated heritage sites. It was once home to the Nehru family and now serves as a museum and memorial, giving visitors a glimpse into India’s political and social past. The architecture and storytelling make it a memorable destination.',
      'Khusro Bagh is a peaceful garden and historical complex that offers a quieter pace compared with the busy city centre. It is perfect if you want a slower walk, a little time outdoors and a connection with the city’s layered past.',
      'Allahabad Fort and the surrounding old-city landmarks make for a fascinating visit for anyone interested in architecture, city history and local stories. The fort area is one of the best places to feel the rhythm of Prayagraj beyond the main tourist highlights.',
      'For a local finish, pair your sightseeing with a short stop at a river-facing market or a family-run eatery. Prayagraj is best experienced when you mix landmarks with food, conversation and a little time simply watching the city go by.',
    ],
  },
  {
    id: 'things-to-do-in-prayagraj',
    publishedAt: '2026-09-12',
    category: 'City guide',
    title: 'Things to Do in Prayagraj',
    excerpt: 'From riverfront evenings and heritage walks to food trails and local shopping, here are the best things to do in Prayagraj.',
    read: '4 min read',
    image: '/images/people/guest-table.jpg',
    alt: 'People enjoying a relaxed evening in Prayagraj',
    keywords: 'things to do in Prayagraj, what to do in Prayagraj, Prayagraj activities, Prayagraj travel ideas',
    seoTitle: 'Things to Do in Prayagraj | Local Experience Guide',
    seoDescription: 'Find the best things to do in Prayagraj, including riverfront walks, heritage visits, local food, shopping and evening city experiences.',
    body: [
      'Prayagraj works best when you let the day unfold slowly. Instead of trying to squeeze in too much, take the city at its pace and enjoy a few experiences that feel distinctly local. The best things to do in Prayagraj often combine food, history and a little time near the river.',
      'Start with a morning visit to Sangam, especially if you want a calm and spiritual start to the day. The riverfront is ideal for a short walk, a quiet moment and a few photos before the city becomes busier. Later, head into the old city or Civil Lines for a heritage walk and a little shopping.',
      'A food trail is one of the best ways to explore Prayagraj. Add a stop at Sardaar JI Dhaba for Punjabi classics, then explore the local streets for sweets, chai and casual snacks. Prayagraj is especially rewarding for travellers who are happy to mix iconic restaurants with small neighbourhood favourites.',
      'If you enjoy history, spend time at Anand Bhawan, Khusro Bagh and the fort area. These places offer a mix of architecture, memory and local colour that makes the city feel layered rather than just modern or religious. You can also combine that with a relaxed evening walk in one of the city’s greener spaces.',
      'For a slower, more personal experience, choose one place to sit, eat and watch the flow of life around you. Prayagraj is a city that feels rich when experienced through routine, not just landmarks. Watch the crowds at the riverfront, linger over a meal, and let the city reveal itself in the bridges, markets and evening light.',
    ],
  },
  {
