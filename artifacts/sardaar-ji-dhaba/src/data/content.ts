...
const additionalStories: BlogPost[] = [
  ...
  },
  {
    ...
    excerpt: 'A first-time visit to Prayagraj is best when you mix the city’s spiritual landmarks, heritage spots and local rhythm into one easy route.',
    read: '4 min read',
    ...
    body: [
      'Prayagraj rewards travellers who move through it with a little patience. This is a city where the most memorable moments often come from a combination of sacred riverfronts, heritage architecture and everyday street life. If you are planning a first visit, these five places make for an excellent starting route.',
      'Start at Triveni Sangam, where the Ganga, Yamuna and the invisible Saraswati meet. It is the city’s spiritual heart, and the riverfront has a calm, reflective energy that feels especially powerful in the early morning. If you want one classic Prayagraj experience, this is it.',
      'Next, make time for Anand Bhawan. It is one of the city’s most important heritage sites and one of the best places to understand how Prayagraj shaped India’s modern political and social history. The building, the exhibits and the atmosphere all make it feel like a place that deserves more than a quick stop.',
      'Khusro Bagh is a brilliant contrast to the larger landmarks. It is quieter, more intimate and beautifully atmospheric, with old tombs, landscaped paths and a strong sense of historical continuity. It is the kind of place that lets you slow down and absorb the city rather than racing through it.',
      'Allahabad Fort is another must-visit destination, especially if you want to feel the city’s old-world character. The fort area and nearby landmarks give you a different version of Prayagraj, one that is rooted in history, architecture and the everyday texture of old neighbourhoods.',
      'For a local finish, turn your visit into a simple city walk through Civil Lines, the markets and the streets around the riverfront. Prayagraj is at its best when you pair landmark sightseeing with food, conversation and a slower pace. That combination is what turns a trip into a genuine experience of the city.',
    ],
  },
  {
    ...
    excerpt: 'Prayagraj is most enjoyable when you mix riverfront moments, heritage walks, food stops and a little time simply watching the city move.',
    read: '4 min read',
